...
import { SubmissionIndex } from "./submission/SubmissionIndex";
import { ClientIndex } from "./client/ClientIndex";
import { LeadIndex } from "./lead/LeadIndex";
      ...
      <MainLayout.Content>
        ...
        <Page>
          <Switch>
            ...
            <PrivateRoute path="/submissions" component={SubmissionIndex} />
            <PrivateRoute path="/clients" component={ClientIndex} />
            <PrivateRoute path="/leads" component={LeadIndex} />
          </Switch>
        </Page>
      </MainLayout.Content>
    </>
